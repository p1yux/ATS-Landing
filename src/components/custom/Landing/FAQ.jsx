          ...
          {faqs.map((faq, index) => (
            ...
            >
              <button
                ...
                className={`w-full py-4 px-6 flex items-center justify-between gap-4 text-left transition-all duration-300 ${
                  openIndex === index 
                    ? 'text-blue-600' 
              ...
              <AnimatePresence>
                {openIndex === index && (
                  ...
                  >
                    <p className="px-6 pb-4 text-gray-600 leading-relaxed text-base">
                      {faq.answer}
                    </p>
                  </motion.div>
                )}
