...
const About = () => {
  return (
    <section id="about" className="py-12 relative overflow-hidden bg-[#F8F8F9]">
      {/* Background Pattern */}
      ...
      <div className="container mx-auto px-4 relative">
        ...
        >
          <div className="h-[1px] w-8 bg-[#25272A]/30"></div>
          <span className="text-sm font-medium text-[#25272A] uppercase tracking-wider">About Us</span>
          <div className="h-[1px] w-8 bg-[#25272A]/30"></div>
        </motion.div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="max-w-3xl mx-auto text-center mb-10">
            ...
            >
              <span className="text-[#25272A]">Reimagining</span>{' '}
              <span className="text-[#25272A]">recruitment</span>{' '}
              <span className="text-[#25272A]">for the</span>{' '}
              <span className="text-[#25272A]">modern era</span>
            </motion.h2>
            <motion.p 
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
          ...
          <div className="grid md:grid-cols-12 gap-8 items-center">
            ...
            >
              <div className="relative h-[350px] rounded-2xl overflow-hidden">
                ...
                <div className="absolute inset-0 bg-gradient-to-tr from-[#25272A]/20 via-[#25272A]/10 to-transparent"></div>
              </div>
              {/* Updated Stats Badge */}
              <div className="absolute -right-3 -bottom-3 bg-white shadow-xl rounded-xl p-4 transition-transform duration-300 hover:-translate-y-1">
                <p className="text-2xl md:text-3xl font-display font-bold text-[#25272A]">85%</p>
              ...
              <div className="space-y-8">
                <div className="space-y-3">
                  <div className="flex items-center gap-3 mb-2">
                    <div className="p-2 bg-[#F8F8F9] rounded-lg">
                      <svg className="w-5 h-5 text-[#25272A]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
                      </svg>
                    </div>
                    <h3 className="text-xl md:text-2xl font-display font-bold">
                      <span className="text-[#25272A]">Built by recruiters,</span>{' '}
                      <span className="text-[#25272A]">powered by AI</span>
                    </h3>
                  </div>
                ...
                <div className="space-y-3">
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <h3 className="text-xl md:text-2xl font-display font-bold">
                      <span className="text-[#25272A]">Focused on</span>{' '}
                      <span className="text-[#25272A]">what matters</span>
                    </h3>
                  </div>
                  <p className="text-gray-600 leading-relaxed">
                ...
                <Button 
                  size="lg"
                  className="group bg-[#25272A] hover:bg-[#404348] text-white shadow-lg hover:shadow-xl transition-all duration-300"
