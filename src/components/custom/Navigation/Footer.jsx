        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 max-w-7xl mx-auto">
          ...
          <div className="space-y-4">
            ...
            <div className="flex space-x-4">
              {/* Social Links */}
              <a href="#" className="text-gray-600 hover:text-[#4146B5] transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="#" className="text-gray-600 hover:text-[#4146B5] text-sm">Features</Link></li>
              <li><Link href="#" className="text-gray-600 hover:text-[#4146B5] text-sm">Pricing</Link></li>
              <li><Link href="#" className="text-gray-600 hover:text-[#4146B5] text-sm">Case Studies</Link></li>
              <li><Link href="#" className="text-gray-600 hover:text-[#4146B5] text-sm">Reviews</Link></li>
            </ul>
          </div>
