        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 max-w-7xl mx-auto">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><span className="text-gray-600 text-sm">Features</span></li>
              <li><span className="text-gray-600 text-sm">Pricing</span></li>
              <li><span className="text-gray-600 text-sm">Case Studies</span></li>
              <li><span className="text-gray-600 text-sm">Reviews</span></li>
            </ul>
          </div>
